...
public class DatabaseManager {
   ...
   /** the JDBC connection URI */
    private static final String DBconnection = "jdbc:mysql://localhost:3306/";
   /** the database */
    private static final String databaseName = "addressBookDB";
     ...
     *       or the already existing Listings table is identified.
     * </pre>
     */          
    ...
    private String [] initListingsTable() {
        ...
        String[]  SQL = {
            ...
            "PREFIX     varchar(3)," +
            "SUFFIX     varchar(4))",
            "insert into Listings values (default, 'ANDERRSON', 'JOHN',  '314', '825', '1695')",
    ...
    public void close(boolean remove){  // closes all open connections                                             
        try {
        	...
        	System.out.println("Saving table LISTINGS");
        }
        } 
        catch ( SQLException e ) {
            System.out.println ("\n*** SQLException caught ***\n");
